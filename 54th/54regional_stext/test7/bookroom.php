    ...
    <body>
        ...
        <div class="maindiv">
            <div class="bookroomleft">
                <div class="flex">
                    <?php
                        $year=padstart((isset($_GET["year"])?$_GET["year"]:date("Y")),4);
                        $month=padstart((isset($_GET["month"])?$_GET["month"]:date("m")),2);
                    ?>
                    ...
                    <?php
                        ...
                        for($i=1;$i<=42;$i=$i+1){
                            if($firstdate<$i&&$date<=$totaldate){
                                $day=$year."-".$month."-".padstart($date,2);
                                ...
                                ?><div class="cdiv cdatediv" id="<?= $date ?>" data-day="<?= $day ?>" data-cost="<?= $cost ?>">
                                    <?= $date ?><br>
                                    <?= count($leftroom) ?>間<br>
                                    <?= $cost ?>
                                </div><?php
