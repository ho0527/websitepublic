...
<html>
    ...
    <body>
        ...
        <div class="nav" id="nav">
            <div class="title">訪客訂房 - 已選擇的訂房資訊在確認</div>
        </div>
        ...
        <div class="main" id="main">
            ...
            <div class="div">
                總金額
                <div id="totalprice">請選擇日期</div>
            </div>
            <div class="div">
                需付討金
                <div id="descipt">請選擇日期</div>
            </div>
            <div class="div text-center">
                <input type="button" class="btn btn-light" onclick="location.href=localStorage.getItem('location')" value="取消">
                <input type="button" class="btn btn-warning" onclick="localStorage.setItem('book',JSON.stringify(book));location.href='bookroomsubmit.php'" value="確定訂房">
            </div>
        </div>
