    ...
    <body>
        ...
        <?php
            if(isset($_POST["submit"])){
                ...
                query("INSERT INTO `bookroom`VALUES(?,?,?,?,?,?,?)",[null,date("Ymd").strpad(4,count($row)+1),$_POST["startday"],$_POST["endday"],$_POST["room"],date("Ymd"),""]);
                ?><script>alert("新增成功");location.href="no.php?no=<?= date("Ymd").strpad(4,count($row)+1) ?>"</script><?php
            }
        ?>
