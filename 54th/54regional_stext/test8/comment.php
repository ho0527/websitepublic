        ...
        <div class="commentmain">
            <?php
                ...
                if(!isset($_GET["keyword"])||$_GET["keyword"]==""){
                    ...
                    $row=query("SELECT*FROM `comment` WHERE (`name` LIKE ?) OR (((`email` LIKE ? AND `emailshow`='checked') OR (`phone` LIKE ? AND `phoneshow`='checked') OR (`content` LIKE ?)) AND `deletetime`='') ORDER BY `pin` DESC,`$orderby` $ordertype",["%".$keyword."%","%".$keyword."%","%".$keyword."%","%".$keyword."%"]);
                }
