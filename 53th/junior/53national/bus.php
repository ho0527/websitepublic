        ...
        <?php
            ...
            if(isset($_SESSION["data"])){
                ...
                <div class="loginhead" id="head">
                    <div class="center">
                        <input type="button" class="loginbutton button selectbutton" onclick="location.href='bus.php'" value="接駁車管理">
                        <input type="button" class="loginbutton button" onclick="location.href='site.php'" value="站點管理">
                    </div>
                </div>
