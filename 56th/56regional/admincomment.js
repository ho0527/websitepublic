ajax("GET",ajaxurl+"/getcommentlist",function(event,data){
    if(data["success"]){
        ...
        for(let i=0;i<row.length;i=i+1){
            ...
            //             <input type="button" class="button outline pincomment fill" data-id="${row[i]["id"]}" value="訂選">
            ...
            //             <input type="button" class="button error deletecomment fill" data-id="${row[i]["id"]}" value="刪除">
            //         </div>
